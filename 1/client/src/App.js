    ...
    <nav className="fixed w-full z-50 transition-all duration-300 bg-[#020617]/90 backdrop-blur-xl text-white border-b border-white/10 shadow-2xl">
      <div className="flex justify-between items-center px-6 lg:px-12 py-3">
        <button onClick={() => onNavigate('home')} className="flex items-center gap-2 z-50 hover:scale-105 transition-transform duration-300">
          <svg className="w-16 h-16" viewBox="0 0 342 35" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="hidden lg:flex space-x-6 text-[13px] font-medium">
          <button onClick={() => onNavigate('vehicles')} className="hover:bg-white/10 backdrop-blur-md px-3 py-2 rounded-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]">Vehicles</button>
          <button onClick={() => onNavigate('energy')} className="hover:bg-white/10 backdrop-blur-md px-3 py-2 rounded-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]">Energy</button>
          <button onClick={() => onNavigate('charging')} className="hover:bg-white/10 backdrop-blur-md px-3 py-2 rounded-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]">Charging</button>
          <button onClick={() => onNavigate('discover')} className="hover:bg-white/10 backdrop-blur-md px-3 py-2 rounded-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]">Discover</button>
          <button onClick={() => onNavigate('shop')} className="hover:bg-white/10 backdrop-blur-md px-3 py-2 rounded-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]">Shop</button>
        </div>

        <div className="hidden lg:flex items-center gap-3 text-[13px] font-medium">
          <button className="hover:bg-purple-50 px-3 py-2 rounded-lg transition-all duration-300 hover:text-purple-600">Shop</button>
          {user ? (
            <>
              <button
...
const Configurator = ({ vehicleId, onBack, onNavigate }) => {
  ...
  }, [config.paint, config.wheels, viewMode, vehicle, currentInteriorIndex]);
